...
def print_compare_db_contents():
    print("DEBUG: Starting 'print_compare_db_contents' function")
    print(f"DEBUG: Database path: {config.DB_TO_COMPARE}")

    # Open database
    try:
        conn = sqlite3.connect(config.DB_TO_COMPARE)
    ...
    print("DEBUG: Finished printing compare DB contents")
